...
class User(AbstractBaseUser, PermissionsMixin, TimeStampedModel):
    ...
    business_logo = models.URLField(max_length=800, blank=True, null=True)
    id_front_page = models.URLField(max_length=800, blank=True, null=True)
    id_back_page = models.URLField(max_length=800, blank=True, null=True)
